...
<body>
    <div class="dashboard">
        <div class="header">
            <div class="logo">
                <a href="#"><img src="assets/images/uthaoo3333.png" alt="Logo" style="width:140px;height:auto;"></a>
            </div>
            <div class="welcome">
        ...
        <div class="main-content">
            <div class="sidebar">
            <ul>
            <li><a href="#" class="active" onclick="openSection('home')"style="font-size:14px;">Home</a></li><hr>
            <li><a href="#" onclick="openSection('add-scraps')" style="font-size:14px;">Add Scraps</a></li><hr>
            <li><a href="#"  onclick="openSection('scrap-request')" style="font-size:14px;">View Requests</a></li><hr>
            <li><a href="#" onclick="openSection('feedback')" style="font-size:14px;">View Feedbacks</a></li><hr>
            <li><a href="../front.php" onclick="openSection('logout')" style="color:red;font-size:14px;">Logout</a></li><hr>
            </ul>
            </div>
                    ...
                    <table>
                        ...
                        <tbody>
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    // echo "<td><img src='uploads/." . $row['image'] . "' alt='Scrap Image' style='max-width: 100px;'></td>";
                                    // echo "<td><img src='uploads/" . $row['image'] . "' alt='Scrap Image' style='max-width: 100px;'></td>";
